        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WarnDaysAhead = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CredentialTypeId = table.Column<Guid>(type: "uuid", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AlertLogs_Credentials_CredentialId",
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "Id", "IsRequired", "Name", "WarnDaysAhead" },
                values: new object[,]
                {
                    { new Guid("11111111-1111-1111-1111-111111111111"), true, "RN License", 60 },
                    { new Guid("22222222-2222-2222-2222-222222222222"), true, "BLS Certification", 30 },
                    { new Guid("33333333-3333-3333-3333-333333333333"), false, "ACLS Certification", 30 },
                    { new Guid("44444444-4444-4444-4444-444444444444"), false, "DEA Registration", 90 },
                    { new Guid("55555555-5555-5555-5555-555555555555"), true, "Malpractice Insurance", 60 }
                });

            migrationBuilder.CreateIndex(
                name: "IX_AlertLogs_CredentialId",
                table: "AlertLogs",
                column: "CredentialId");
